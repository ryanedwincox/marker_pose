...
Matrix4d SolveP3P::solveP3P(cv::Mat worldCoord, cv::Mat imageCoord, cv::Mat cameraMatrix, cv::Mat distCoeffs, cv::Mat rvec, cv::Mat tvec, int foo, int baz)
{
    this->foo = foo;
    this->baz = baz;
...
////    cout << "a_b_c_: " << a_ << ", " << b_ << ", " << c_ << endl;
////    cout << "sqrt: " << pow(b_,2) - 4*a_*c_ << endl;
////    X_[0] = (-b_ + sqrt(pow(b_,2) - 4*a_*c_)) / (2*a_);
////    X_[1] = (-b_ - sqrt(pow(b_,2) - 4*a_*c_)) / (2*a_);
////    cout << "X_: " << X_[0] << ", " << X_[1] << endl;
...
//    cout << "TS10a: " << ts10a << endl;
//    cout << "TS10b: " << ts10b << endl;
...
//    cout << "TS11a: " << ts11a << endl;
//    cout << "TS11b: " << ts11b << endl;
